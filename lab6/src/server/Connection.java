    ...
    public String  take(){
        ...
        try  {
            ...
            while (true) {
                ...
                if (recscan.hasNextInt()){
                int port1 = recscan.nextInt();
                int port2 = recscan.nextInt();
                recscan.hasNextInt();
                System.out.println(port);

                //System.out.println(recscan.nextLine());
                if (port1 == port2){
                    serverSocket.close();
...
//            out.flip();
 ...
 //           out.position(4);
    ...
    public void sendfile(String consolemessage){
        try (DatagramSocket serverSocket = new DatagramSocket()) {
            File myFile = new File("/home/s242096/str.csv"); // read file "/Users/nursat/workspace/lab6/src/server/str.csv"
